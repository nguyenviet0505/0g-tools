...
**Đổi tên Validator:**
```
evmosd tx staking edit-validator --website="" --details="Thông tin miêu tả Validator" --new-moniker="Tên validator mới" --from=" tên wallet" --identity="" --commission-rate=0.05 --gas=500000 --gas-prices=99999aevmos -y
```
...
```
evmosd tx staking delegate $(evmosd keys show "tên node" --bech val -a)  4900000000000000000aevmos --from "tên ví" --gas=500000 --gas-prices=99999aevmos -y
```
Example:
```
evmosd tx staking delegate $(evmosd keys show "josephtran" --bech val -a)  4900000000000000000aevmos --from "josephtran" --gas=500000 --gas-prices=99999aevmos -y
```
